      ...
      <div className="max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="space-y-12">
          ...
          <div className="flex space-x-4">
            <a
              href="https://wa.me/918859332491?text=Hi%20I%20am%20interested%20in%20your%20treks"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-3 px-6 py-3 bg-emerald-500/20 border border-emerald-500/30 rounded-full text-emerald-400 text-xs uppercase tracking-widest hover:bg-emerald-500/30 transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-3 px-6 py-3 bg-pink-500/20 border border-pink-500/30 rounded-full text-pink-400 text-xs uppercase tracking-widest hover:bg-pink-500/30 transition-all"
            >
              <Instagram size={16} />
              <span>Instagram</span>
            </a>
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="glass p-10 rounded-3xl">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <input type="text" placeholder="Your Name" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-sm text-white placeholder-white/20 focus:outline-none focus:border-gold" />
              <input type="tel" placeholder="Phone / WhatsApp" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-sm text-white placeholder-white/20 focus:outline-none focus:border-gold" />
            </div>

            <input type="email" placeholder="Email" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-sm text-white placeholder-white/20 focus:outline-none focus:border-gold" />

            <textarea rows={4} placeholder="Your Message..." className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-sm text-white placeholder-white/20 focus:outline-none focus:border-gold resize-none" />

            <button className="w-full py-5 bg-gold text-charcoal text-xs uppercase tracking-[0.3em] font-bold rounded-full hover:bg-white transition-all">
              Send Message
            </button>
          </div>
        </motion.div>
